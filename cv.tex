...
\cvitem{Bibliothèques}{ % Frameworks et \\ bibliothèques}{
  %% \textbf{GTK+},
  \textbf{Scikit-learn},
...
\cvitem{Systèmes}{
  ...
  utilitaires système classiques, % (rsync, tar, wget, sed, etc),
  Docker,
  Vagrant,
  Salt
  %% VirtualBox
...
\cventry{2020}{Continuation d'un projet de stage en projet personnel}{}{}{}{
  Création d'un solveur Rust pour logiques non monotones.
}
\cventry{2020}{Stage de deux mois}{Laboratoire d'Informatique \& Systèmes (LIS) de Marseille}{}{}{
  Travail sur un système de calcul argumentatif en IA symbolique.% (équipe LIRICA).
}

\cventry{2019}{Stage de deux mois}{Laboratoire d'Informatique \& Systèmes (LIS) de Marseille}{}{}{
...
\cventry{2018\,-\,2019}{Projets durant le Bachelor}{pédagogiques}{}{}{
  \begin{itemize}
  \item Conception et réalisation d'un moteur de jeu 3D écrit en C++ utilisant OpenGL et SDL2.
  \item Implémentation de l'algorithme de recherche de chemin IDA*.
  \item Implémentation de divers effets graphiques, notamment de «\,l'alpha blending\,» et des ombres.
  \end{itemize}
}
...
\cventry{2016--2018}{DUT Informatique en alternance}{IUT AMU}{Aix-en-Provence}{}{}
